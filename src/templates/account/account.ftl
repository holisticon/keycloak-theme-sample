...
<@layout.mainLayout active='account' bodyClass='user'; section>
    ...
    <form action="${url.accountUrl}" class="form-horizontal" method="post">
        ...
        <div class="form-group">
            <div class="col-sm-3 col-md-3">
                <label for="user.attributes.crm_api_key" class="control-label">${msg("crm_api_key")}</label>
            </div>

            <div class="col-sm-9 col-md-9">
                <input type="text" class="form-control" id="user.attributes.crm_api_key" name="user.attributes.crm_api_key" value="${(account.attributes.crm_api_key!'')}"/>
            </div>
        </div>
